...
public class ReadWriterExceptionTest {
    ...
    public void testWriterExceptionMapper() throws Exception {
        ...
        JAXBMarshalException jaxbEOne = new
                JAXBMarshalException("JAXBMarshalException's WriterException test one");
        ...
        JAXBMarshalException jaxbETwo = new
                JAXBMarshalException("JAXBMarshalException's WriterException test one",
        ...
        JAXBMarshalException jaxbE = new
                JAXBMarshalException("JAXBMarshalException's WriterException test",
    ...
    public void testReaderExceptionMapper() throws Exception {
        ...
        JAXBUnmarshalException jaxbEOne = new
                JAXBUnmarshalException("JAXBUnmarshalException's ReaderException test one");
        Response resultOne = eHandler.handleException(request, jaxbEOne);
        ...
        // there is an exception cause object, return status code for the cause when
        // there is a mapper for that cause class.
        JAXBUnmarshalException jaxbETwo = new
                JAXBUnmarshalException("JAXBUnmarshalException's ReaderException test one",
                new SprocketDBException());
        factory.registerProvider(SprocketDBExceptionMapper.class);
        Response resultTwo = eHandler.handleException(request, jaxbETwo);
        ...
        JAXBUnmarshalException jaxbE = new
                JAXBUnmarshalException("JAXBUnmarshalException's ReaderException test",
