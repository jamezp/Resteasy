...
public class ServerReload {
    ...
    public static void executeReloadAndWaitForCompletion(final ModelControllerClient client, final int timeout) {
        ...
        waitForLiveServerToReload(timeout, TestUtil.getManagementHost(), TestUtil.getManagementPort());
    }
    ...
    private static void waitForLiveServerToReload(final int timeout, final String serverAddress, final int serverPort) {
        ...
        while (System.currentTimeMillis() - start < timeout) {
            ...
            try (
                    ModelControllerClient liveClient = ModelControllerClient.Factory.create("remote+http",
