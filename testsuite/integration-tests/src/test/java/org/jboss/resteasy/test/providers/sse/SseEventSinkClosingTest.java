...
public class SseEventSinkClosingTest {
    ...
    public void testFilterForEventSent() throws Exception {
        ...
        try {
            ...
            try (
                    Response response = baseTarget.path(SseEventSinkClosingTestResource.SEND_AND_CLOSE_PATH)
    ...
    public void testFilterForMethodReturn() throws Exception {
        ...
        try {
            ...
            try (
                    Response response = baseTarget.path(SseEventSinkClosingTestResource.CLOSE_WITHOUT_SENDING_PATH)
                            .request(MediaType.SERVER_SENT_EVENTS_TYPE).get()
            ) {
