...
public class ConfigSourceOverrideOrdinalFilterTest {
    ...
    public static Archive<?> deploy() {
        WebArchive war = TestUtil.prepareArchive(ConfigSourceOverrideOrdinalFilterTest.class.getSimpleName())
    ...
    private String generateURL(String path) {
        return PortProviderUtil.generateURL(path, ConfigSourceOverrideOrdinalFilterTest.class.getSimpleName());
    }
