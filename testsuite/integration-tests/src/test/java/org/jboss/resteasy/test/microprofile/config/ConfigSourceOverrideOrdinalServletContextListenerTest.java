...
public class ConfigSourceOverrideOrdinalServletContextListenerTest {
    ...
    public static Archive<?> deploy() {
        WebArchive war = TestUtil.prepareArchive(ConfigSourceOverrideOrdinalServletContextListenerTest.class.getSimpleName())
    ...
    private String generateURL(String path) {
        return PortProviderUtil.generateURL(path, ConfigSourceOverrideOrdinalServletContextListenerTest.class.getSimpleName());
    }
